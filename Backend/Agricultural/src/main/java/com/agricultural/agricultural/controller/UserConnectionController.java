...
public class UserConnectionController {
    ...
    public ResponseEntity<ApiResponse<Boolean>> checkConnectionStatus(
            @PathVariable Integer targetUserId,
            @AuthenticationPrincipal User user) {
        
        boolean areConnected = userConnectionService.areUsersConnected(user.getId(), targetUserId);
        return ResponseEntity.ok(new ApiResponse<>(true, "Kiểm tra trạng thái kết nối thành công", areConnected));
    }
