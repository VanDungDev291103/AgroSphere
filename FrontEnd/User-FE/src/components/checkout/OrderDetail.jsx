...
const OrderDetail = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span className={`${statusInfo.bg} ${statusInfo.text} text-sm font-medium px-3 py-1 rounded-full`}>
        {statusInfo.label}
      </span>
    );
  };
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                <div>
                  <p className="text-sm text-gray-500 mb-1">Đơn hàng #{order.id}</p>
                  <p className="text-sm">Ngày đặt: {formatDate(order.orderDate)}</p>
                </div>
                <div>
              ...
              <div className="space-y-3">
                ...
                <div className="border-t border-gray-200 pt-3 mt-3">
                  <div className="flex justify-between font-semibold">
                    <span>Tổng cộng:</span>
                    <span className="text-red-500 text-xl">{order.totalAmount.toLocaleString()}đ</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={
                    order.status === "COMPLETED" || order.status === "SHIPPING" || order.status === "PROCESSING" 
